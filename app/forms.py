...
class UserQuestionCheck(FlaskForm):
    Question1 = RadioField('Question 1: ', coerce=str, choices=[('A','A'),('B','B'),('C','C'),('D','D')] , validators=[DataRequired()])
    Question2 = RadioField('Question 2: ', coerce=str, choices=[('A','A'),('B','B'),('C','C'),('D','D')] , validators=[DataRequired()])
    Question3 = RadioField('Question 3: ', coerce=str, choices=[('A','A'),('B','B'),('C','C'),('D','D')] , validators=[DataRequired()])
